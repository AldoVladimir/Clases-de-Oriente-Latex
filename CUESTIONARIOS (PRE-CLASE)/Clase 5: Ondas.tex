...
Este examen diagnóstico evalúa tres aspectos:
\begin{itemize}
    \item \textbf{Conocimiento del tema:} qué tanto sabes de ondas antes de la lección.
    \item \textbf{Velocidad de respuesta:} el examen de admisión tiene tiempo límite estricto.
    \item \textbf{Capacidad para eliminar distractores:} identificar errores comunes en las opciones.
\end{itemize}

\textbf{Procedimiento:}
\begin{enumerate}
    \item Responde las 10 preguntas en máximo \textbf{15 minutos}.
    ...
    \item Anota tus respuestas en formato: 1-A, 2-C, 3-B\ldots
    \item Al terminar, revisa las respuestas en la sección siguiente.
\end{enumerate}
\end{instruccionbox}
