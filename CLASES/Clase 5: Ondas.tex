...
\newpage
\textbf{Ejercicio} Relaciona las siguientes columnas:

\begin{center}
\begin{tabular}{lp{0.55\textwidth}}
\textbf{I.}   Onda transversal         & a. onda en la que las partículas vibran en la misma dirección en que se propaga la onda. \\[0.25cm]
\textbf{II.}  Velocidad de propagación & b. es la distancia que existe entre valles o crestas. \\[0.25cm]
\textbf{III.} Frecuencia               & c. onda en la que las partículas vibran perpendicularmente a la dirección de propagación de la onda. \\[0.25cm]
\textbf{IV.}  Longitud de onda         & d. velocidad con la que se mueve una onda en un medio. \\[0.25cm]
\textbf{V.}   Onda longitudinal        & e. número de ondas que pasan por un punto en un segundo. \\
\end{tabular}
\end{center}

\begin{ecuacion}
\textbf{Respuesta correcta: I-c, II-d, III-e, IV-b, V-a}
\begin{itemize}
    \item \textbf{I-c:} La onda transversal oscila perpendicularmente a su propagación (cuerdas, luz).
    \item \textbf{II-d:} La velocidad de propagación es cuán rápido viaja la perturbación en el medio.
    \item \textbf{III-e:} La frecuencia cuenta ciclos por segundo (Hz).
    \item \textbf{IV-b:} La longitud de onda $\lambda$ es la distancia entre dos crestas o dos valles consecutivos.
    \item \textbf{V-a:} La onda longitudinal oscila paralelamente a su propagación (sonido, ondas P sísmicas).
\end{itemize}
\end{ecuacion}
...
\textbf{Ejercicio } En la figura, las circunferencias continuas representan las crestas y las circunferencias punteadas los valles, en un instante dado, de dos ondas producidas en la superficie de un líquido.

\begin{center}
    \includegraphics[width=0.20\textwidth]{CLASES/IMAGENES/interferencia_ejercicio.png}
\end{center}

Con base en la figura, responde:

\begin{enumerate}
    \item ¿En qué punto interfieren constructivamente las crestas?
    \item¿En qué punto interfieren constructivamente dos valles?
    \item ¿En qué punto interfieren destructivamente un valle y una cresta?
    \item Si la amplitud de cada onda es de 3.2 cm, ¿cuál es la amplitud de la vibración en los puntos P, Q, R?
\end{enumerate}

\begin{ecuacion}
\textbf{Respuestas:}
\begin{itemize}
    \item \textbf{9.} Punto P --- dos crestas se superponen: interferencia constructiva.
    \item \textbf{10.} Puntos Q --- dos valles se superponen: interferencia constructiva. 
    \item \textbf{11.} Punto R --- una cresta y un valle se anulan: interferencia destructiva. 
    \item \textbf{12.} P: 6.4 cm (cresta + cresta), \quad Q: 6.4 cm (valle + valle), \quad R: 0 cm (cresta + valle).
\end{itemize}
\end{ecuacion}
